...
if(isset($_POST["category"])){
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
			<li class=''><a href='#' class='category' cid='$cid'>$cat_name</a></li>
			";
		}
		echo "</div>";
	}
...
if(isset($_POST["brand"])){
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
		<li class=''><a href='#' class='selectBrand' bid='$bid'>$brand_name</a></li>
			";
		}
		echo "</div>";
	}
				...
				<div class='col-md-4'>
							<div class='panel panel-primary'>
								...
								<div class='panel-body'>
									<a  href='product_details.php?p_id=$pro_id'> <img src='product_images/$pro_image' style='width:160px; height:250px;'/> 
									View</a>
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	if(isset($_POST["addToProduct"])){
		...
		$sql = "SELECT * FROM cart WHERE p_id = '$p_id' AND user_id = '$user_id' AND status='0' ";
		$run_query = mysqli_query($con,$sql);
		$count = mysqli_num_rows($run_query);
		if($count > 0){
			echo "
...
if(isset($_POST["get_cart_product"]) || isset($_POST["cart_checkout"])){
	...
	if($count > 0){
		...
		echo '
				...
				<form action="checkOut_m.php" method="post">
				...
				<input class="btn btn-success btn-lg" style="float:right;margin-right:10px;" type="submit" name="Checkout" value="Checkout"
